...
export class UpdateAverageCostTrigger1771100000000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      BEGIN
        SELECT
          COALESCE(SUM("numberOfCertificates" * COALESCE("price", 0)), 0),
          COALESCE(SUM("numberOfCertificates"), 0)
    ...
    await queryRunner.query(`
      ...
      AFTER INSERT OR UPDATE OR DELETE ON "certificate_transactions"
      FOR EACH STATEMENT
